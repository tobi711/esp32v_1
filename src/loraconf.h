...
static const u1_t DEVEUI[8] = { 0x00, 0x57, 0xA9, 0x35, 0x46, 0x45, 0xBD, 0xA3 };

static const u1_t APPEUI[8] = { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x03, 0x85, 0x83 };

static const u1_t APPKEY[16] = { 0x91, 0xAB, 0xFC, 0xA4, 0xF3, 0xD2, 0x52, 0xA2, 
                                    0x8F, 0xE7, 0x9C, 0x44, 0x5C, 0x10, 0x2A, 0xD1 };
